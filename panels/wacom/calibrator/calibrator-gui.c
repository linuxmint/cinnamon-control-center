                ...
                int             threshold_misclick)
{
  ...
  calib_area->builder = gtk_builder_new_from_resource ("/org/cinnamon/control-center/wacom/calibrator/calibrator.ui");
  ...
  gtk_css_provider_load_from_resource (calib_area->style_provider, "/org/cinnamon/control-center/wacom/calibrator/calibrator.css");
